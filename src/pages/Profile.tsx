...
const Profile = () => {
  ...
  return (
    <div className="min-h-dvh bg-background text-foreground">
      <SEOHead title="Profile: Coach Kay Elevates" description="Manage your Coach Kay Elevates profile, update your coaching preferences, and view your clarity stats." path="/profile" noIndex />
      {/* Header */}
