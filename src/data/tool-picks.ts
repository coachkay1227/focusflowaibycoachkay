...
export const TOOL_PICKS: ToolPick[] = [
  ...
  {
    name: "Descript",
    why: "Edit video and audio like a doc. How I batch coaching content without burning a week.",
    category: "Productivity",
  ...
  {
    name: "Stripe",
    why: "Every payment in this room runs through Stripe. Honest pricing needs an honest checkout.",
    category: "Payments",
