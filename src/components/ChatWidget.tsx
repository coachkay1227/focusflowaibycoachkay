...
const PAGE_CONTEXT_MAP: Record<string, PageContext> = {
  ...
  '/store': {
    ...
    options: [
      { label: "What's the best book for beginners?", followUp: "Start with the AI Starter Kit — it's built for someone brand new to AI. Practical, no fluff, no jargon.", route: '/store' },
  ...
  '/': {
    ...
    options: [
      ...
      { label: "I want to use AI but don't know how", followUp: "Start with the free AI Starter Kit — it's built for exactly that moment.", route: '/starter-kit' },
