...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/events/claude-ai-business-accelerator-june-2026", priority: "0.4", changefreq: "yearly" },
  ...
  { path: "/agents/builds", priority: "0.8", changefreq: "weekly" },
  { path: "/agents/lead-engine", priority: "0.8", changefreq: "weekly" },
  { path: "/agents/hermes", priority: "0.7", changefreq: "monthly" },
  { path: "/agent-builder", priority: "0.8", changefreq: "monthly" },
  { path: "/advisory", priority: "0.8", changefreq: "monthly" },
  { path: "/build-studio", priority: "0.9", changefreq: "weekly" },
  { path: "/start-a-build", priority: "0.8", changefreq: "monthly" },
  { path: "/truth", priority: "0.95", changefreq: "weekly" },
  { path: "/ai-task-force", priority: "0.7", changefreq: "monthly" },
  { path: "/collective", priority: "0.6", changefreq: "monthly" },
